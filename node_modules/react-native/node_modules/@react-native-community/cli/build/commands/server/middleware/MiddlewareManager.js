...
class MiddlewareManager {
  constructor(options) {
    ...
    .use((0, _compression().default)()).use('/debugger-ui', (0, _cliDebuggerUi().debuggerUIMiddleware)()).use((0, _openStackFrameInEditorMiddleware.default)(this.options)).use(_openURLMiddleware.default).use(_statusPageMiddleware.default).use(_systraceProfileMiddleware.default).use(_indexPage.default).use((0, _errorhandler().default)());
  }
